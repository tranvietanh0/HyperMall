        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && jwtTokenProvider.validateToken(jwt)) {
                ...
                if (shouldUseUserDetailsService()) {
                    ...
                    // Create authentication directly from JWT (other services)
                    authentication = createAuthenticationFromToken(jwt);
                }
            ...
            log.error("Could not set user authentication in security context: [{}] {}", ex.getClass().getSimpleName(), ex.getMessage());
        }
